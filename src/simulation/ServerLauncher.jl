...
function print_banner(port::Int, policy)
    ...
    println("   POST http://localhost:$port/api/modules/transport-point/run")
    ...
    println("   GET  http://localhost:$port/api/modules/script-tasks")
    println("   POST http://localhost:$port/api/modules/script-tasks/jobs")
    println("   GET  http://localhost:$port/api/modules/script-tasks/jobs/{job_id}")
    println("   GET  http://localhost:$port/api/modules/script-tasks/jobs/{job_id}/result")
    println("\n⚙️  部署策略:")
