...
const CORE_SMOKE_FILES = [
    ...
    joinpath(REGRESSION_DIR, "relaxtime", "test_phase_guided_transport_mode_b_regression.jl"),
    joinpath(REGRESSION_DIR, "relaxtime", "test_phase_guided_first_order_branch_regression.jl"),
