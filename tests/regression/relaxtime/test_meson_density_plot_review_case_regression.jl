...
const OVERLAY_PNG_PATH = joinpath(PLOT_REVIEW_DIR, "overlay_kminus_piminus_mu_pi_100.png")
const RESIDUAL_PNG_PATH = joinpath(PLOT_REVIEW_DIR, "residual_kminus_piminus_mu_pi_100.png")
