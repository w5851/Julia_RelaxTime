...
@testset "ScatteringAmplitude Unit Tests" begin
    ...
    @testset "Test 1: Different Scattering Processes" begin
        integration_println("\n" * "="^70)
        integration_println("Test 1: Different Scattering Processes")
        ...
        @testset "qq scattering: $process" for process in qq_processes
            ...
            integration_println("  $process: |M|² = $(round(M_squared, digits=6)) fm⁻⁴")
        end
        ...
        @testset "qq scattering: ss_to_ss (high energy)" begin
            ...
            integration_println("  ss_to_ss (s=50.0): |M|² = $(round(M_squared, digits=6)) fm⁻⁴")
        end
        ...
        integration_println("✓ All scattering processes produce valid amplitudes")
    end
    ...
    @testset "Test 2: Amplitude with Different K_coeffs Values" begin
        integration_println("\n" * "="^70)
        integration_println("Test 2: Amplitude with Different K_coeffs Values")
        integration_println("="^70)
        ...
        integration_println("  Standard K: |M|² = $(round(M_squared_standard, digits=6)) fm⁻⁴")
        integration_println("  K = 0:      |M|² = $(round(M_squared_K0, digits=6)) fm⁻⁴")
        integration_println("  K = 2K₀:    |M|² = $(round(M_squared_2K, digits=6)) fm⁻⁴")
        integration_println("  K = 0.5K₀:  |M|² = $(round(M_squared_halfK, digits=6)) fm⁻⁴")
        integration_println("✓ Amplitude varies with K_coeffs as expected")
    end
    ...
    @testset "Test 3: Amplitude Depends on Coupling Strengths" begin
        integration_println("\n" * "="^70)
        integration_println("Test 3: Amplitude Depends on Coupling Strengths")
        integration_println("="^70)
        ...
        integration_println("  Standard G: |M|² = $(round(M_squared_standard, digits=6)) fm⁻⁴")
        integration_println("  G = 2G₀:    |M|² = $(round(M_squared_2G, digits=6)) fm⁻⁴")
        integration_println("  G = 0.5G₀:  |M|² = $(round(M_squared_halfG, digits=6)) fm⁻⁴")
        ...
        integration_println("  Ratio (2G/G₀): $(round(ratio_2G, digits=3))")
        integration_println("  Ratio (0.5G/G₀): $(round(ratio_halfG, digits=3))")
        
        # Verify that doubling G increases amplitude (not necessarily by factor of 4)
        @test M_squared_2G > M_squared_standard
        @test M_squared_halfG < M_squared_standard
        
        integration_println("✓ Amplitude depends on coupling strengths as expected")
    end
    ...
    @testset "Test 4: Amplitude at Different Kinematic Points" begin
        integration_println("\n" * "="^70)
        integration_println("Test 4: Amplitude at Different Kinematic Points")
        integration_println("="^70)
        ...
        for s_val in s_values
            ...
            integration_println("    s = $(s_val) fm⁻²: |M|² = $(round(M_squared, digits=6)) fm⁻⁴")
        end
        ...
        for t_val in t_values
            ...
            @test M_squared >= 0.0 && isfinite(M_squared)
            integration_println("    t = $(t_val) fm⁻²: |M|² = $(round(M_squared, digits=6)) fm⁻⁴")
        end
        
        integration_println("✓ Amplitude is well-behaved across kinematic range")
    end
    ...
    @testset "Test 5: Amplitude with Different Quark Masses" begin
        integration_println("\n" * "="^70)
        integration_println("Test 5: Amplitude with Different Quark Masses")
        integration_println("="^70)
        ...
        for m_test in mass_values
            ...
            @test M_squared >= 0.0 && isfinite(M_squared)
            integration_println("    m_u = $(m_test) fm⁻¹: |M|² = $(round(M_squared, digits=6)) fm⁻⁴")
        end
        
        integration_println("✓ Amplitude varies with quark mass as expected")
    end
    ...
    @testset "Test 6: Symmetry Relations" begin
        integration_println("\n" * "="^70)
        integration_println("Test 6: Symmetry Relations")
        integration_println("="^70)
        ...
        integration_println("  udbar_to_udbar: |M|² = $(round(M_udbar, digits=6)) fm⁻⁴")
        integration_println("  dubar_to_dubar: |M|² = $(round(M_dubar, digits=6)) fm⁻⁴")
        integration_println("  Difference: $(abs(M_udbar - M_dubar))")
        ...
        integration_println("  usbar_to_usbar: |M|² = $(round(M_usbar, digits=6)) fm⁻⁴")
        integration_println("  subar_to_subar: |M|² = $(round(M_subar, digits=6)) fm⁻⁴")
        integration_println("  Difference: $(abs(M_usbar - M_subar))")
        
        integration_println("✓ Symmetry relations satisfied")
    end
    ...
    @testset "Test 7: Struct vs NamedTuple Interface" begin
        integration_println("\n" * "="^70)
        integration_println("Test 7: Struct vs NamedTuple Interface")
        integration_println("="^70)
        ...
        integration_println("  Struct-derived: |M|² = $(round(M_squared_struct, digits=10)) fm⁻⁴")
        integration_println("  NamedTuple:     |M|² = $(round(M_squared_nt, digits=10)) fm⁻⁴")
        integration_println("  Difference: $(abs(M_squared_struct - M_squared_nt))")
        integration_println("✓ Struct and NamedTuple interfaces produce identical results")
    end
    
end

integration_println("\n" * "="^70)
integration_println("ScatteringAmplitude Unit Tests Complete!")
integration_println("="^70)
integration_println("\nAll unit tests passed:")
integration_println("  1. Different scattering processes tested")
integration_println("  2. Amplitude varies with K_coeffs values")
integration_println("  3. Amplitude depends on coupling strengths")
integration_println("  4. Amplitude well-behaved across kinematic range")
integration_println("  5. Amplitude varies with quark mass")
integration_println("  6. Symmetry relations satisfied")
integration_println("  7. Struct and NamedTuple interfaces equivalent")
integration_println("="^70)
