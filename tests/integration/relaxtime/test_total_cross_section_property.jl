...
@testset "TotalCrossSection Property Tests" begin
    ...
    @testset "Property: Struct-NamedTuple Equivalence" begin
        ...
        @check max_examples=(_ci ? 10 : 20) function property_total_cross_section_equivalence(
            ...
            σ_struct = TotalCrossSection.total_cross_section(
            ...
            σ_nt = TotalCrossSection.total_cross_section(
    ...
    @testset "Property: Struct Workflow Support" begin
        ...
        @check max_examples=(_ci ? 5 : 10) function property_struct_workflow_support(
            ...
            s = 20.0
            all_σ_struct = TotalCrossSection.calculate_all_total_cross_sections(
