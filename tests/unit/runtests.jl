...
const CORE_SMOKE_FILES = [
    ...
    joinpath(UNIT_DIR, "relaxtime", "test_causal_spectral_bubble.jl"),
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_pereira_reference.jl"),
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_pnjl_stability.jl"),
    ...
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_source_continuation.jl"),
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_infinite_thermal.jl"),
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_infinite_profile.jl"),
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_infinite_yield.jl"),
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_infinite_acceptance.jl"),
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_infinite_qgate.jl"),
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_infinite_limits.jl"),
    ...
    joinpath(UNIT_DIR, "relaxtime", "test_causal_gbu_dense_execution.jl"),
