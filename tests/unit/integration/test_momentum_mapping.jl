...
@testset "MomentumMapping Tests" begin
    ...
    @testset "Basic scattering calculation" begin
        ...
        result = calculate_outgoing_momenta(p1, p2, m1, m2, m3, m4, π/4, π/6)
    ...
    @testset "Mandelstam variables" begin
        ...
        t = MomentumMapping.calculate_mandelstam_t(result)
        u = MomentumMapping.calculate_mandelstam_u(result, m, m, m, m)
    ...
    @testset "Threshold check" begin
        ...
        # 这应该会抛出阈值错误
        @test_throws ErrorException calculate_outgoing_momenta(p1, p2, m_in, m_in, m_out, m_out, π/4, π/6)
