...
@testset "strict charged phase backend physical diagnostic contract" begin
    ...
    @test occursin("charged_pair_continuum_thresholds", source)
    @test occursin("threshold_coordinate=\"external_k0\"", source)
    @test occursin("pair_continuum_threshold_lambda_q0_inv_fm", source)
