...
@testset "task ledger real state" begin
    ...
    @test tracks["formula-route-closure"]["current_branch"] == "codex/charged-phase-normalization"
    @test tracks["formula-route-closure"]["current_sha"] == "976b064c2082b370bfd574433c3d44574cd5dc41"
