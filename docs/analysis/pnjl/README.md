...
| endpoint-local contract/shadow | `../pnjl_cep_endpoint_local_contract_feasibility_v2/`、`../pnjl_cep_endpoint_local_production_shadow_v4/`、`../pnjl_cep_endpoint_local_production_shadow_v4_20260813/` |
