...
并记录 `25` 个 active consumer/rollback blocker，因此本次不具备 physical deletion 条件。
...
`accepted_for_downstream` is a downstream data decision only. It does not change strict runtime selection, legacy rollback, or the physical deletion gate.
