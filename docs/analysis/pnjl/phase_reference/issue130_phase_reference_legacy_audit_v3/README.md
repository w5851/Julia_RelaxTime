...
repo HEAD：`863dea0bc4dcec660a720831783df42fcb5868f8`；calculation SHA：`3c5f6b3c9bd535cff7657364dadb2efc31f2ea48`。

## Verdict

- `accepted_primary_runtime_ready_path_retirement_pending`
- accepted primary runtime ready：`True`
- runtime legacy fallback rows：`0`；rollback enabled：`False`
- active legacy path contracts pending migration：`6`
- physical deletion eligible：`False`
- next action：migrate remaining active legacy path contracts, then rerun this audit
