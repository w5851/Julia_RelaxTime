...
- Exported symbol count: 281
- Mentioned in non-generated docs/api pages: 171
...
| `AbstractPipelineIOContract` | src/models/Models.jl | 127 | 0 | - |
...
| `Constants_PNJL` | src/models/Models.jl | 143 | 13 | docs/api/integrals/GaussLegendre.md<br>docs/api/integrals/OneLoopIntegrals.md<br>docs/api/models/derived/derivatives/Overview.md |
...
| `Integrals` | src/models/Models.jl | 142 | 13 | docs/api/integrals/CauchyPV.md<br>docs/api/integrals/OneLoopIntegrals.md<br>docs/api/integrals/OneLoopIntegralsAniso.md |
...
| `PHASE_PIPELINE_STAGE_IDS` | src/models/Models.jl | 134 | 0 | - |
| `PMSeedPair` | src/models/Models.jl | 140 | 0 | - |
| `PM_BRANCH_STATUSES` | src/models/Models.jl | 139 | 0 | - |
| `PM_COMPARISON_STATUSES` | src/models/Models.jl | 139 | 0 | - |
| `PM_ENDPOINT_CAUSES` | src/models/Models.jl | 139 | 0 | - |
| `PM_SEED_SOURCES` | src/models/Models.jl | 139 | 0 | - |
...
| `PipelineArtifact` | src/models/Models.jl | 128 | 0 | - |
| `PipelineContext` | src/models/Models.jl | 128 | 1 | docs/api/models/workflows/PhasePipeline.md |
| `PipelineIOContract` | src/models/Models.jl | 127 | 1 | docs/api/models/workflows/PhasePipeline.md |
| `PipelineProvenance` | src/models/Models.jl | 128 | 0 | - |
| `PipelineRunResult` | src/models/Models.jl | 130 | 0 | - |
| `PipelineSpec` | src/models/Models.jl | 128 | 1 | docs/api/models/workflows/PhasePipeline.md |
| `PipelineStage` | src/models/Models.jl | 128 | 1 | docs/api/models/workflows/PhasePipeline.md |
| `PipelineStageRecord` | src/models/Models.jl | 130 | 0 | - |
...
| `StageResult` | src/models/Models.jl | 128 | 0 | - |
| `TmuScanConfig` | src/models/Models.jl | 144 | 1 | docs/api/PARAMETER_TYPES_API.md |
...
| `TrhoScanConfig` | src/models/Models.jl | 144 | 1 | docs/api/PARAMETER_TYPES_API.md |
...
| `analyze_pm_branch_competition` | src/models/Models.jl<br>src/models/entrypoints.jl | 141, 20 | 3 | docs/api/models/phase/Overview.md<br>docs/api/models/phase/PMPhaseDiagnostic.md<br>docs/api/models/phase/README.md |
...
| `build_default_rho_grid` | src/models/Models.jl<br>src/models/entrypoints.jl | 111, 12 | 5 | docs/api/models/scans/Algorithms.md<br>docs/api/models/scans/Overview.md<br>docs/api/models/scans/README.md |
| `build_governance_candidate` | src/models/Models.jl | 77 | 0 | - |
| `build_implicit_solver` | src/models/Models.jl | 39 | 0 | - |
| `build_manifest_extensions` | src/models/Models.jl | 132 | 0 | - |
| `build_njl_problem` | src/models/Models.jl | 40 | 0 | - |
| `build_phase_artifacts` | src/models/Models.jl<br>src/models/entrypoints.jl | 124, 18 | 3 | docs/api/models/phase/Algorithms.md<br>docs/api/models/phase/Overview.md<br>docs/api/models/phase/README.md |
...
| `cached_nodes` | src/models/Models.jl | 142 | 0 | - |
| `calculate_chiral` | src/models/Models.jl | 19 | 1 | docs/api/data_contracts.md |
| `calculate_energy_sum` | src/models/Models.jl | 142 | 0 | - |
...
| `calculate_number_densities` | src/models/Models.jl | 142 | 0 | - |
...
| `classify_pipeline_error` | src/models/Models.jl | 133 | 0 | - |
...
| `compute_pipeline_artifact_hash` | src/models/Models.jl | 131 | 0 | - |
| `compute_pipeline_config_hash` | src/models/Models.jl | 131 | 0 | - |
...
| `default_scan_numeric_options` | src/models/Models.jl<br>src/models/entrypoints.jl | 112, 13 | 0 | - |
...
| `derive_pm_seed_pair` | src/models/Models.jl<br>src/models/entrypoints.jl | 141, 20 | 0 | - |
...
| `explicit_residual!` | src/models/Models.jl | 91 | 0 | - |
| `find_cep` | src/models/Models.jl<br>src/models/entrypoints.jl | 124, 18 | 5 | docs/api/models/phase/Algorithms.md<br>docs/api/models/phase/Overview.md<br>docs/api/models/phase/PhaseTransition.md |
...
| `gas_liquid_workflow_module` | src/models/Models.jl<br>src/models/entrypoints.jl | 121, 23 | 0 | - |
...
| `list_precompile_capabilities` | src/models/Models.jl | 147 | 0 | - |
| `list_precompile_profile` | src/models/Models.jl | 147 | 0 | - |
...
| `magnetic_thermodynamics_module` | src/models/Models.jl<br>src/models/entrypoints.jl | 123, 30 | 0 | - |
...
| `meson_workflow_module` | src/models/Models.jl<br>src/models/entrypoints.jl | 120, 21 | 4 | docs/api/models/workflows/CoreConcepts.md<br>docs/api/models/workflows/ModuleAccessors.md<br>docs/api/models/workflows/Overview.md |
...
| `normalize_adapter_kwargs` | src/models/Models.jl | 133 | 0 | - |
...
| `normalize_pm_seed_pair` | src/models/Models.jl<br>src/models/entrypoints.jl | 140, 20 | 0 | - |
...
| `persisted_string_to_symbol` | src/models/Models.jl | 129 | 0 | - |
| `persisted_symbol_to_string` | src/models/Models.jl | 129 | 0 | - |
| `pm_next_seed_source` | src/models/Models.jl<br>src/models/entrypoints.jl | 140, 20 | 0 | - |
| `pnjl_module` | src/models/Models.jl<br>src/models/entrypoints.jl | 115, 29 | 4 | docs/api/models/workflows/CoreConcepts.md<br>docs/api/models/workflows/ModuleAccessors.md<br>docs/api/models/workflows/Overview.md |
...
| `promote_phase_artifacts` | src/models/Models.jl<br>src/models/entrypoints.jl | 125, 19 | 3 | docs/api/models/phase/Algorithms.md<br>docs/api/models/phase/Overview.md<br>docs/api/models/phase/README.md |
...
| `relaxtime_orchestrator_stage_ids` | src/models/Models.jl | 135 | 0 | - |
...
| `resolve_phase_output_target` | src/models/Models.jl<br>src/models/entrypoints.jl | 125, 19 | 3 | docs/api/models/phase/Algorithms.md<br>docs/api/models/phase/Overview.md<br>docs/api/models/phase/README.md |
| `rotation_workflow_module` | src/models/Models.jl<br>src/models/entrypoints.jl | 121, 22 | 0 | - |
| `run_phase_pipeline` | src/models/Models.jl<br>src/models/entrypoints.jl | 124, 18 | 8 | docs/api/models/phase/Algorithms.md<br>docs/api/models/phase/Crossover.md<br>docs/api/models/phase/Overview.md |
| `run_phase_pipeline_via_runner` | src/models/Models.jl | 134 | 1 | docs/api/models/workflows/PhasePipeline.md |
| `run_pipeline` | src/models/Models.jl | 131 | 1 | docs/api/models/workflows/PhasePipeline.md |
| `run_precompile_capability` | src/models/Models.jl | 146 | 0 | - |
| `run_precompile_profile` | src/models/Models.jl | 146 | 0 | - |
| `run_precompile_workload` | src/models/Models.jl | 145 | 0 | - |
| `run_production_phase_pipeline` | src/models/Models.jl<br>src/models/entrypoints.jl | 124, 18 | 3 | docs/api/models/phase/Algorithms.md<br>docs/api/models/phase/Overview.md<br>docs/api/models/phase/README.md |
| `run_relaxtime_orchestrator_pipeline` | src/models/Models.jl<br>src/models/entrypoints.jl | 138, 28 | 1 | docs/api/relaxtime/workflow/TransportWorkflow.md |
| `run_scan_pipeline` | src/models/Models.jl<br>src/models/entrypoints.jl | 137, 27 | 1 | docs/api/models/workflows/Overview.md |
| `run_tmu_scan` | src/models/Models.jl<br>src/models/entrypoints.jl | 110, 12 | 7 | docs/api/PARAMETER_TYPES_API.md<br>docs/api/models/scans/Algorithms.md<br>docs/api/models/scans/Overview.md |
| `run_trho_scan` | src/models/Models.jl<br>src/models/entrypoints.jl | 110, 12 | 8 | docs/api/PARAMETER_TYPES_API.md<br>docs/api/models/phase/Algorithms.md<br>docs/api/models/scans/Algorithms.md |
| `run_workflow_pipeline` | src/models/Models.jl<br>src/models/entrypoints.jl | 136, 26 | 1 | docs/api/models/workflows/Overview.md |
| `scan_pipeline_stage_ids` | src/models/Models.jl | 135 | 0 | - |
...
| `solve` | src/models/Models.jl | 62 | 43 | docs/api/PARAMETER_TYPES_API.md<br>docs/api/README.md<br>docs/api/data_contracts.md |
...
| `solve_gap_and_meson_point` | src/models/Models.jl<br>src/models/entrypoints.jl | 117, 15 | 8 | docs/api/PARAMETER_TYPES_API.md<br>docs/api/models/workflows/CoreConcepts.md<br>docs/api/models/workflows/MesonMassWorkflow.md |
| `solve_gap_and_transport` | src/models/Models.jl<br>src/models/entrypoints.jl | 116, 14 | 10 | docs/api/PARAMETER_TYPES_API.md<br>docs/api/models/workflows/CoreConcepts.md<br>docs/api/models/workflows/Overview.md |
| `solve_gas_liquid_point` | src/models/Models.jl<br>src/models/entrypoints.jl | 119, 16 | 3 | docs/api/models/variants/gas_liquid/CoreConcepts.md<br>docs/api/models/variants/gas_liquid/Overview.md<br>docs/api/models/variants/gas_liquid/README.md |
...
| `solve_named` | src/models/Models.jl | 66 | 1 | docs/api/models/solver/Overview.md |
| `solve_pnjl_point` | src/models/Models.jl<br>src/models/entrypoints.jl | 112, 13 | 0 | - |
...
| `solve_rotation_point` | src/models/Models.jl<br>src/models/entrypoints.jl | 118, 17 | 3 | docs/api/models/variants/rotation/CoreConcepts.md<br>docs/api/models/variants/rotation/Overview.md<br>docs/api/models/variants/rotation/README.md |
| `solve_transport_from_equilibrium` | src/models/Models.jl<br>src/models/entrypoints.jl | 116, 14 | 7 | docs/api/PARAMETER_TYPES_API.md<br>docs/api/models/workflows/CoreConcepts.md<br>docs/api/models/workflows/Overview.md |
| `solve_vec` | src/models/Models.jl | 66 | 1 | docs/api/models/solver/Overview.md |
...
| `transport_workflow_module` | src/models/Models.jl<br>src/models/entrypoints.jl | 120, 21 | 4 | docs/api/models/workflows/CoreConcepts.md<br>docs/api/models/workflows/ModuleAccessors.md<br>docs/api/models/workflows/Overview.md |
...
| `vacuum_integral` | src/models/Models.jl | 142 | 0 | - |
| `validate_schema` | src/models/Models.jl | 83 | 0 | - |
| `vec_to_named` | src/models/Models.jl | 84 | 0 | - |
| `workflow_module_for` | src/models/entrypoints.jl | 25 | 2 | docs/api/models/workflows/CoreConcepts.md<br>docs/api/models/workflows/Overview.md |
| `workflow_param_adapters_module` | src/models/Models.jl<br>src/models/entrypoints.jl | 122, 24 | 4 | docs/api/models/workflows/CoreConcepts.md<br>docs/api/models/workflows/ModuleAccessors.md<br>docs/api/models/workflows/Overview.md |
| `workflow_pipeline_stage_ids` | src/models/Models.jl | 135 | 0 | - |
