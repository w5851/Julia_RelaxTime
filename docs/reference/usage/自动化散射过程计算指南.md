...
### Q: 如何验证映射表的正确性？
A: 参考 `doc/formula/散射过程所有可能.md` 中的表格，与常量表对照检查。

## 参考文献

- 散射过程列表：`doc/formula/散射过程所有可能.md`
- 传播子公式：`doc/formula/Propagator_传播子byPolarization.md`
- 总传播子公式：`doc/formula/总传播子byPropagator.md`
