...
```
## 3. 额外说明
- PNJL模型下，参数需要加上Φ和Φbar；f(E-μ)和f(E+μ)分别表示夸克和反夸克的有效分布函数，具体形式见 [PNJL_夸克有效分布函数.md](../../pnjl/distribution/PNJL_夸克有效分布函数.md)（更详细推导见 [PNJL_夸克有效分布函数_补充详细说明.md](../../pnjl/distribution/PNJL_夸克有效分布函数_补充详细说明.md)）。
