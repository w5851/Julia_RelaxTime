...
- workflow output: `data\outputs\results\relaxtime\meson_density\freezeout_validation\blaschke2019col_kminus_piminus_mu_pi_100_phase_shift_gbu_constTproxy\workflow_scan.csv`
- comparison output: `data\outputs\results\relaxtime\meson_density\freezeout_validation\blaschke2019col_kminus_piminus_mu_pi_100_phase_shift_gbu_constTproxy\comparison_vs_target.csv`
...
- model range: `[ 0.000974, 0.022577 ]`
- mean abs diff: `0.10011925775883572`
- max abs diff: `0.1477812263342661`
- mean rel diff: `0.8040536966419356`
- max rel diff: `0.872976942591565`
