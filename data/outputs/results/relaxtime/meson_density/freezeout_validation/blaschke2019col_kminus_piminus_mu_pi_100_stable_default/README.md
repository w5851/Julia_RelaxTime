...
- regime: `stable`
- workflow output: `data\outputs\results\relaxtime\meson_density\freezeout_validation\blaschke2019col_kminus_piminus_mu_pi_100_stable_default\workflow_scan.csv`
- comparison output: `data\outputs\results\relaxtime\meson_density\freezeout_validation\blaschke2019col_kminus_piminus_mu_pi_100_stable_default\comparison_vs_target.csv`
...
- model range: `[ 0.0, 0.1391 ]`
- mean abs diff: `0.01842516960878707`
- max abs diff: `0.030184226334266095`
- mean rel diff: `0.15179703960261895`
