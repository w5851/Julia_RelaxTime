...
- regime: `strict_bw_stage2`
- workflow output: `data\outputs\results\relaxtime\meson_density\freezeout_validation\blaschke2019col_kminus_piminus_mu_pi_100_strict_bw_stage2_default\workflow_scan.csv`
- comparison output: `data\outputs\results\relaxtime\meson_density\freezeout_validation\blaschke2019col_kminus_piminus_mu_pi_100_strict_bw_stage2_default\comparison_vs_target.csv`
...
- model range: `[ 0.0, 0.139081 ]`
- mean abs diff: `0.018434982108787072`
- max abs diff: `0.030203226334266087`
- mean rel diff: `0.15186477566688675`
