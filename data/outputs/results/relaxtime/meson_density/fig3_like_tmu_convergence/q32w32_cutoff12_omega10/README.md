...
- path strategy: `tmu`
- density regimes: `phase_shift_gbu_reference`
- fixed-mu path values: `mu_q=0.000000,300.000000 MeV`
- temperature range: `160.0:20.0:220.0 MeV`
- flavor profile: `default`
- meson profile: `default`

## Outputs

- CSV: `data\outputs\results\relaxtime\meson_density\fig3_like_tmu_convergence\q32w32_cutoff12_omega10\combined_meson_density_scan.csv`
