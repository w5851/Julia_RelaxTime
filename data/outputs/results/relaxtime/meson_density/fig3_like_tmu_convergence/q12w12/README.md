...
- fixed-mu path values: `mu_q=0.000000,150.000000,300.000000 MeV`
...
- CSV: `data\outputs\results\relaxtime\meson_density\fig3_like_tmu_convergence\q12w12\combined_meson_density_scan.csv`
